...
export default function SignUpForAdvice() {
  ...
  let placeholder = {
    ...
    address: t("Địa chỉ đầy đủ"),
    nameOfParcel: t("Tên hàng hóa"),
    totalOfParcel: t("Số lượng hàng hóa/tháng")
  }
  return (
          ...
          >
            <div className=" lg:border-t-2 border-[#F2F2F2] lg:pb-10 lg:pt-6">
              <div className="flex flex-col items-start">
                ...
                <span className=" text-[#161D25] text-lg lg:text-[#8A8E92] lg:w-[350px] lg:text-[14px] block my-4 lg:my-0 ">
                  {t('Chọn một trong các dịch vụ TKTL đang cung cấp')}
                </span>
              </div>
              <div>
            ...
            <div className=" lg:border-t-2 border-[#F2F2F2] lg:pb-10 lg:pt-6">
              <div className="flex flex-col">
                <span className="font-bold text-[#fcd535] uppercase block mb-3 lg:mb-0 text-xl">
                  {t('Thông tin người gửi')}
                </span>
                <span className=" text-[#161D25] text-lg lg:text-[#8A8E92] lg:w-[350px] lg:text-[14px] block my-4 lg:my-0 ">
                  {t('Nhập thông tin chi tiết người gửi hàng hóa')}
                </span>
              </div>
              <div>
            ...
            <div className=" lg:border-t-2 border-[#F2F2F2] lg:pb-10 lg:pt-6">
              <div className="flex flex-col">
                ...
                <span className=" text-[#161D25] text-lg lg:text-[#8A8E92] lg:w-[350px] lg:text-[14px] block my-4 lg:my-0 ">
                  {t('Nhập địa chỉ chi tiết của người gửi hàng hóa')}
                </span>
              </div>
            ...
            <div className=" lg:border-t-2 border-[#F2F2F2] lg:pb-8 lg:pt-6">
              <div className="flex flex-col">
                <span className="font-bold text-[#fcd535] uppercase block mb-3 lg:mb-0 text-xl">
                  {t('Thông tin hàng hóa gửi đi')}
                </span>
                <span className=" text-[#161D25] text-lg lg:text-[#8A8E92] lg:w-[350px] lg:text-[14px] block my-4 lg:my-0 ">
                  {t('Nhập thông tin chi tiết hàng hóa được gửi đi')}
                </span>
              </div>
                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center border px-2 w-full rounded-[2px] border-[#ced4da] h-[43px]">
                    ...
                    <input
                      ...
                      type="text"
                      name="goods_name"
                      placeholder={placeholder.nameOfParcel}
                ...
                <div className="w-full mt-4">
                  ...
                  <div className="flex items-center border px-2 w-full rounded-[2px] border-[#ced4da] h-[43px]">
                    ...
                    <input
                      ...
                      type="number"
                      name="goods_amount"
                      placeholder={placeholder.totalOfParcel}
            ...
            <div className="pb-[40px] lg:pb-0" onClick={handleSubmit}>
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <span className="ml-2">{t('Đăng ký tư vấn')}</span>
                </button>
              </div>
            </div>
          </form>
