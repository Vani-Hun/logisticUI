...
//----------------------------------------------//
export { default as JMagazine } from "./Blog/JMagazine";
export { default as Event } from "./Blog/Event";
export { default as IndustryNews } from "./Blog/IndustryNews";
export { default as BlogDetail } from "./Blog/BlogDetail";
export { default as ResultSearchBlog } from "./Blog/ResultSearchBlog";
...
export { default as AdminSubCom } from "./Admin/AdminSubCom.jsx";
...
export { default as AdminObject} from "./Admin/AdminObject.jsx";
...
export { default as AdminPostOffice } from "./Admin/AdminPostOffice";
export { default as AdminChat } from "./Admin/AdminChat";
export { default as AdminLifeStyle } from "./Admin/AdminLifeStyle";

export { default as CustomChat } from "./Message/CustomChat";
