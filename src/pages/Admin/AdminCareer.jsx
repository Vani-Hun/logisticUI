...
function AdminCareer() {
  ...
  const fetchData = async (params = {}) => {
    setLoading(true);
    try {
      // const { data: response } = await axios.get(`${END_POINT}/admin/career/`, {
      ...
      setPagination({
        ...
        total: res.data.data.careers.length,
  ...
  return (
    <>
      <div className="flex justify-between mb-4">
        <span className="text-3xl font-bold uppercase">Tuyển Dụng</span>
