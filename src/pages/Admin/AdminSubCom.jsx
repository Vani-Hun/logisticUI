...
import AdminEditCommit from "../../components/Admin/SubCommit/AdminEditSubCommit";
import AdminAddCommit from "../../components/Admin/SubCommit/AdminAddSubCommit";
import ConfirmModal from "../../components/ConfirmModal";
import { AiFillEdit, AiOutlineDelete } from "react-icons/ai";
import { END_POINT } from "../../utils/constant";
export default function AdminSubCom() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${END_POINT}/admin/sub-commitment`,
      {
        headers: { 'x-access-token': `${accessToken}` },
      });
      console.log("cam kết phụ", response.data.data);
  ...
  const acceptDelete = async () => {
    ...
    try {
      const res = await axios.delete(
        `${END_POINT}/admin/sub-commitment/${IdCompare}`,
        {
          headers: { 'x-access-token': `${accessToken}` },
        }
      );
