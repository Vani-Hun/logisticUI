...
import AddPostOffice from "../../components/Admin/PostOffice/AddPostOffice";
import EditPostOffice from "../../components/Admin/PostOffice/EditPostOffice";
...
function AdminPostOffice() {
  ...
  const acceptDelete = async () => {
    ...
    try {
      await axios.delete(
        `${END_POINT}/admin/post-office/${IdCompare}`,
        {
          headers: { 'x-access-token': `${accessToken}` },
        },
      );
  ...
  return (
    <div>
      <div className="flex justify-between mb-4">
        <span className="text-3xl font-bold uppercase">Bưu cục</span>
...
export default AdminPostOffice;
