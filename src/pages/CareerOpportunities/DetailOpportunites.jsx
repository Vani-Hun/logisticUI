...
const DetailOpportunites = () => {
  ...
  useEffect(() => {
    console.log(params);
    const getData = async () => {
      const api = await axios.get(`${END_POINT}/career/detail/${params.id}`);
          ...
          <div className="m-auto px-[16px] lg:px-[30px]  mt-[30px]">
            ...
            <div className="gap-4 lg:grid lg:grid-cols-2 bg-[#f2f2f2]">
              ...
              <div className="p-4">
                ...
                <p className="py-2 ml-5">{data?.salary}</p>
                <hr />
              </div>
              <div className="p-4">
                <h4 className="text-[#e5a663] font-bold">
              ...
              <div className="p-4">
                ...
                <p className="py-2 ml-5">{data?.addressDescription}</p>
                <hr />
              </div>
            </div>
            ...
            <article className="tracking-wide">
              ...
              {data.jobDescription && data.jobDescription.map((jobDescription, index) => {
                return <p key={index}>
                  <FontAwesomeIcon
                    className="mr-2 text-[#e5a663]"
                    icon={faCircle}
              ...
              <h4 className="mt-8 mb-2 text-2xl font-bold">Yêu cầu công việc</h4>
              {data.jobRequirements && data.jobRequirements.map((jobRequirement, index) => {
                return <p key={index}>
                  <FontAwesomeIcon
                    className="mr-2 text-[#e5a663]"
                    icon={faCircle}
              ...
              <h4 className="mt-8 mb-2 text-2xl font-bold">Đãi ngộ</h4>
              {data.perks && data.perks.map((perk, index) => {
                return <p key={index}>
                  <FontAwesomeIcon
                    className="mr-2 text-[#e5a663]"
                    icon={faCircle}
