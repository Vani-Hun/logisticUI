...
export default function VanDon() {
  ...
  const handleSubmit = async () => {
    ...
    //   url: `${END_POINT}/order/search/trackingOrder`,
    //   params: {
    //     orderCode: '25149346,24858480,44669582'
    //   }
    ...
    // console.log(data);
      ...
      const { data: { data }} = await axios.get(`${END_POINT}/order/search/trackingOrder`,{
        params: queryParams
      });
      console.log(data)
      setData(data);

      // const info = await axios.get(`${END_POINT}/order/search/trackingOrder`, {
      //   params: {
      //     orderCode: '25149346,24858480,44669582'
      //   }
      // });
      // console.log(info.data);
      // setPrice(info.data.data);
    ...
    return (
      ...
      >
        <textarea
          ...
          name="billcode"
          placeholder="Ex: 47283639, 21625339"
        />
        <div>
          <span className="text-[#161D25] block my-[24px]">
            {t('Nhập mã vận đơn của bạn (cách nhau bởi dấu phẩy), tối đa 10 vận đơn.')}
          </span>
          <button
