...
const Footer = () => {
  const { contactUs, aboutUs } = useContext(MainContext);
      ...
      <div className=" grid grid-cols-1 gap-x-[70px] lg:grid-cols-3 pt-[35px] mx-auto px-4 lg:px-0 container ">
        <div className="leading-6 ">
          ...
          <div className="text-[12px] mb-1 ">
            <p>
              ...
              {t(aboutUs.businessLicense)}
            </p>
            <p>
              {t(aboutUs.licenseOrgan)}
            </p>
          </div>
          <a href={aboutUs.licenseDetail} target="_blank">
        ...
        <div>
          ...
          <div className="flex text-[12px] justify-around">
            ...
            <div className="">
              <div className="mb-2">
                <p className="mb-[4px] font-bold">{t('Tra cứu')}</p>
              ...
              <div className="mb-2">
                <p className="mb-[4px] font-bold">{t("Dịch Vụ")}</p>
        ...
        <div>
          ...
          <div className="flex">
            ...
            /> */}
            <img src={`${contact.QR_code}`} className="w-20 mr-2" alt="Ảnh QR Code" />
            <div >
              <a></a>
              <a href={contact.ios_app}>
                <img src={appStore} alt="appStore-logo" />
              </a>
              <a href={contact.android_app}>
