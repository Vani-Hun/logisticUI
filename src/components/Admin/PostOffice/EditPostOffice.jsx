...
const { Item } = Form;
function EditPostOffice({ onClose, data, refetchData }) {
    ...
    try {
      if(district != null && province != null && ward != null){
        const response = await axios({
          method: 'patch',
          url: `${END_POINT}/admin/post-office/${data._id}`,
        ...
        await axios.patch(`${END_POINT}/admin/post-office/${data._id}`, dataEdit, {
          headers: { 'x-access-token': `${accessToken}` },
        });
      }
      setLoading(false);
      ...
      <div className="fixed inset-0  bg-slate-600 bg-opacity-50 z-20 flex justify-center items-center">
        <div className="relative w-[700px] flex flex-col bg-white p-6 gap-y-3 animate-modal_in mx-4 rounded-xl overflow-auto">
          ...
          >
            ...
            <div className="flex justify-end mt-2 text-sm gap-x-7">
              <Button
                size="large"
                disabled={isDisable}
                className={
