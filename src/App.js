...
import AdminQuote from "./pages/Admin/AdimQuote";
...
import AdminStrength from "./pages/Admin/AdminStrength";
        ...
        <BrowserRouter>
          <div className="wrapper overflow-hidden">
            ...
            <Routes>
              ...
              <Route path="/custom-chat" element={<CustomChat socket={socket}/>} />
              <Route path="/" element={<DefaultLayout />}>
                ...
                <Route path="tin-tuc-noi-bat" element={<IndustryNews />} />
                <Route path="j-magazine" element={<JMagazine />} />
                <Route path="su-kien" element={<Event />} />
                <Route path="search-result" element={<ResultSearchBlog />} />
                <Route path="chi-tiet-blog/:blogId" element={<BlogDetail />} />
              ...
              <Route element={<StaffRoute />}>
                ...
                <Route path="quan-tri" element={<AdminPage />}>
                  ...
                  <Route path="life-style" element={<AdminLifeStyle />}></Route>
                  <Route path="strength" element={<AdminStrength />}></Route>
                  <Route path="lien_he" element={<AdminContactUs />}></Route>
                  <Route
                    path="commitment"
                    element={<AdminCommitment />}
                  ></Route>
                  <Route path="subcommitment" element={<AdminSubCom />}></Route>
                  <Route
                    path="tin_nhan"
                  ...
                  <Route path="trich_dan" element={<AdminQuote />}></Route>
                  <Route path="buu_cuc" element={<AdminPostOffice />}></Route>
                  <Route path="admin_chat" element={<AdminChat socket={socket}/>}></Route>
                </Route>
              </Route>
            </Routes>
          </div>
